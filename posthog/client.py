...
from posthog.exception_utils import (
    ...
    capture_local_variables_for_exception,
    handle_in_app,
...
class Client(object):
    ...
    def __init__(
        ...
        # Set default context variable state for local variables capture
        if self.enable_code_variables_capture:
            set_code_variables_include(True)
