...
class AsyncAio:
    """
    Async interface that mimics genai.Client().aio with PostHog tracking.
    """
...
class AsyncModels:
    ...
    async def generate_content(
        ...
        **kwargs: Any,
        ...
        """
        Generate content using Gemini's async API while tracking usage in PostHog.
    ...
    def _generate_content_streaming(
        ...
        **kwargs: Any,
        ...
        """
        Factory function that returns an async generator for streaming content.

        Note: This method is intentionally NOT async - it returns an async generator
        that callers can iterate with `async for`.
        """
