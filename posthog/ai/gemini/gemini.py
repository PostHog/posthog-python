...
class Chats:
    """
    Chats interface that mimics genai.Client().chats with PostHog tracking.
    """
    ...
    def create(
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            posthog_distinct_id: ID to associate with the usage event
            posthog_trace_id: Trace UUID for linking events
            posthog_properties: Extra properties to include in the event
            posthog_privacy_mode: Whether to redact sensitive information
            posthog_groups: Group analytics properties
            **kwargs: Arguments passed to chats.create
        """
        # Merge PostHog parameters
        distinct_id, trace_id, properties, privacy_mode, groups = (
            self._merge_posthog_params(
...
class Chat:
    """
    Chat interface that mimics genai.chats.Chat with PostHog tracking.
    """
    ...
    def _send_message_adapter(self, contents=None, **kwargs):
        return self._chat.send_message(message=contents, **kwargs)
    ...
    def _send_message_stream_adapter(self, contents=None, **kwargs):
        return self._chat.send_message_stream(message=contents, **kwargs)
    ...
    def send_message_stream(
        ...
        **kwargs: Any,
        ...
        response = self._chat.send_message_stream(
