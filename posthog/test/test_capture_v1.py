...
class TestBuildV1BatchBody(unittest.TestCase):
    ...
    def test_created_at_passthrough_used_verbatim(self) -> None:
        ...
        body = build_v1_batch_body([], created_at="2026-06-27T12:00:00+00:00")
...
class TestPostV1(unittest.TestCase):
    def _post(self, response, **kwargs):
        ...
        body = build_v1_batch_body([to_v1_event(_msg("u-1"))])
        post_v1(
            "phc_key",
    ...
    def test_url_uses_v1_path_and_trims_host(self) -> None:
        ...
        self.assertEqual(call["url"], "https://app.posthog.com" + CAPTURE_V1_PATH)
    ...
    def test_required_headers_present(self) -> None:
        ...
        self.assertEqual(headers[HEADER_ATTEMPT], "2")
        self.assertEqual(headers[HEADER_REQUEST_ID], "req-123")
        self.assertTrue(headers[HEADER_SDK_INFO].startswith("posthog-python/"))
