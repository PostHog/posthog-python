"""Portkey AI gateway chat completions via OpenAI-compatible API, tracked by PostHog via OpenTelemetry."""
...
resource = Resource(attributes={SERVICE_NAME: "example-portkey-app"})
